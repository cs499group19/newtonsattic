...
class Instructor(models.Model):
    name = models.CharField(max_length=255)
    agePreferences = models.IntegerField(default=0) #I'm assuming this would just be an age number
    ...
    specialty = ArrayField (
        models.ForeignKey(Class, on_delete=models.PROTECT) #Dawn was assuming specialty was just the classes they could teach
    )
...
class Class(models.Model):
    name = models.CharField(max_length=255)
    ageGroup = models.CharField(max_length=10) #Just a written '??-??'
...
class Document(models.Model):
    name = models.CharField(max_length=255)
    forClass = models.ForeignKey(Class, on_delete=models.PROTECT)
